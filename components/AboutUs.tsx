		...
		<div className="lg:px-0  px-2 ">
			<div className="grid md:grid-cols-2 auto-rows-[1fr] bg-[rgb(245,240,237)] ">
				...
				<div className="md:-order-1 flex justify-center items-center h-full">
					<FadeInOut
						{...animationProps}
						className="px-10 space-y-8 xl:space-y-20"
					>
						<h2 className="font-notoSerifKhitan  text-center font-medium text-lg xl:text-2xl">
							Born from a <span>passion</span> for artistry and elegance, Scent
							of a Dream is dedicated to <span>crafting</span> fragrances that{" "}
							<span>inspire</span> and <span>captivate</span>
						</h2>
						<p className=" text-center font-roboto text-sm xl:text-base">
							Our mission is to create scents that resonate with individuality
							and elegance, each bottle an invitation to a new sensory
							adventure.
						</p>
					</FadeInOut>
				</div>
