...
const AboutUs = () => {
  return (
    <div className='grid md:grid-cols-2 place-content-center '>
      ...
      <div className='md:-order-1 flex justify-center items-center bg-[rgb(237,237,238)]'>
        <div className='md:py-10 px-10 md:space-y-10 py-48 space-y-20'>
          <h2 className='font-notoSerifKhitan text-center text-2xl'>
