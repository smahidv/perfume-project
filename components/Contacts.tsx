  ...
  return (
    <div className='bg-white flex justify-center items-center md:h-screen h-[80vh] px-4'>
      <div className="space-y-10 ">
        ...
        <div>
        <p className="md:text-[2.68rem]  text-3xl max-w-[20ch] mx-auto leading-normal text-center">Stay up to date and never miss out.</p>  
        </div>
        <div className=" relative">
          <input type="text" placeholder="Your Email Address" className="font-sans md:h-14 h-12 md:w-[550px] bg-[#f9f9f9] border-[1px] rounded-md border-[#d8d6d6] p-4 focus:outline-none focus:shadow-lg " />
          <button type="button" className="absolute hover:bg-[#f50202] transition-colors duration-500 rounded-lg px-4 py-2 w-[30%] h-[80%] bg-black text-white top-[50%] -translate-y-[50%] right-2">
