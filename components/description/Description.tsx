		...
		<TOCContext.Provider value={values}>
			<div className="px-2  lg:px-16" ref={ref}>
				<FadeInOut
					...
					className="md:py-28 py-10 md:text-6xl text-[1.5rem] font-notoSerifKhitan  overflow-hidden xs:text-3xl md:leading-[5rem] max-w-[75%] font-medium m-auto text-center"
				>
